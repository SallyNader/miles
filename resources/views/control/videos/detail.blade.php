...
<div class="title_left">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                      <div class="product-image" style="margin-left: 35px" >
  ...
  <source src="" type="video/mp4">
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
                      ...
                      <h3 class="prod_title">Video Name</h3>

                      <p>{{$video->vName}} </p>


                        <h3 class="prod_title">Video Description</h3>

                      <p>{{$video->vDisc}} </p>

                      <h3 class="prod_title">YouTube Link</h3>

                      <p>{{$video->youtubeLink}} </p>


                      <h3 class="prod_title">Approved In Home Page</h3>

                      <p>



@if($video->appearInHome == 1)
yes
@elseif($video->appearInHome==0)
no
@endif
