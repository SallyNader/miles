      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;margin-left: 39px">
            ...
            <div class="profile clearfix">
              <div class="profile_pic" style="margin-left: 29px">
                <img src="{!!asset('unit/0.png')!!}" style="height: 66px;width: 130px" alt="..." class="img-circle profile_img">
              </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Unit <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a><i class="fa fa-play"></i> Contacts <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{route('controlcontact.index')}}">All Contacts</a></li>
                      <li><a href="{{route('controlcontact.create')}}">Add New Contact</a></li>
