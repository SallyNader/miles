  ...
  <div class="title_left">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Create New Region <small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    file="true" enctype="multipart/form-data" action="{{route('controlregion.store')}}">
                    {{csrf_field()}}
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="region name" value="{{old('name')}}" type="text">
