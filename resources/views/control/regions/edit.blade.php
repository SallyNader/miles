               ...
               <div class="row" style="width:900px ;margin-left: 99px">
                        ...
                        <div class="thumbnail" style="width:500px ;height:300px ">
                          <div class="image view view-first" style="width:120% ;height: 164%">
                            <img style="width: 83%;height: 60%; display: block;" src="{!!asset('region/'.$region->rPic)!!}" alt="image" />
                            <div class="mask">
                              <p>Your Text</p>
                  ...
                  <div class="x_content">
                    ...
                    file="true" enctype="multipart/form-data" action="{{route('controlregion.update',$region->rId)}}" >
 {{ method_field('PUT') }}
 {{ csrf_field() }}
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="region name" value="{{$region->rName}}" type="text">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="city" placeholder="in city" value="{{$region->rCity}}" type="text">
