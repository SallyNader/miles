              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    file="true" enctype="multipart/form-data" action="{{route('controltype.update',$type->tId)}}" >
 {{ method_field('PUT') }}
 {{ csrf_field() }}
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="type name" value="{{$type->tStatus}}" type="text">
